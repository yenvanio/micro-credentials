(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(authService, fs) {
                    this.authService = authService;
                    this.fs = fs;
                    this.title = 'anonymous-badger';
                }
                AppComponent.prototype.handleSignOut = function () {
                    console.log('Signing Out...');
                    this.authService.SignOut();
                };
                AppComponent.prototype.handleSignIn = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var GoogleButtonComponent = /** @class */ (function () {
                function GoogleButtonComponent() {
                ...
                GoogleButtonComponent.prototype.buttonClicked = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            SecureInnerPagesGuard.ctorParameters = function () { return [
                { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BadgesComponent = /** @class */ (function () {
                function BadgesComponent(fs, as) {
                    this.fs = fs;
                    this.as = as;
                ...
                BadgesComponent.prototype.getBadges = function () {
                    var _this = this;
                    var badges = [];
                    this.fs.getBadges(this.as.uid).subscribe(function (res) {
                        ...
                        _this.badges = badges;
                        console.log(_this.badges);
                    });
                };
                BadgesComponent.prototype.deleteBadge = function (id) {
                    console.log(id);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(as, bs, fs, afs, fb, sbs, dialog, router) {
                    this.as = as;
                    this.bs = bs;
                    this.fs = fs;
                    this.afs = afs;
                ...
                HomeComponent.prototype.navigateToProfile = function (id) {
                    this.router.navigate(["profile/" + id]);
                };
                HomeComponent.prototype.openModal = function (badge) {
                    var dialogRef = this.dialog.open(BadgeModal, {
                        width: '350px',
                        data: badge
                    });
                    dialogRef.afterClosed().subscribe(function (result) { });
                };
                HomeComponent.prototype.getRecommendations = function () {
                    var _this = this;
                    var recommendations = [];
                    this.fs.getRecommendations().subscribe(function (res) {
                        res.forEach(function (b) {
                            var d = b.data;
                            d.id = b.id;
                ...
                HomeComponent.prototype.getUser = function () {
                    var _this = this;
                    this.fs.getUser(this.as.uid).subscribe(function (res) {
                        _this.user = res;
                    });
                };
                HomeComponent.prototype.getUsers = function () {
                    var _this = this;
                    var users = [];
                    this.fs.getUsers().subscribe(function (res) {
                        res.forEach(function (b) {
                            var d = b;
                            if (_this.as.uid != d.uid) {
                                users.push(b);
                            }
                        });
                        console.log(users);
                ...
                HomeComponent.prototype.createFormGroups = function () {
                ...
                HomeComponent.prototype.isValidCourse = function (fc) {
                    return !this.addCourse.get(fc).valid && this.addCourse.get(fc).touched;
                };
                HomeComponent.prototype.isValidLogin = function (fc) {
                    return !this.loginBadger.get(fc).valid && this.loginBadger.get(fc).touched;
                };
                HomeComponent.prototype.isFileUploaded = function () {
                ...
                HomeComponent.prototype.uploadFile = function (file) {
                    var _this = this;
                    var path = "/badges/" + Date.now() + "_" + Math.random();
                    var task = this.afs.upload(path, file).then(function () {
                        var ref = _this.afs.ref(path);
                        ref.getDownloadURL().subscribe(function (url) {
                            console.log(url);
                            _this.downloadableURL = url;
                            console.log(_this.addCourse.invalid);
                        });
                    });
                };
                // Handle Add Course Form Submission
                HomeComponent.prototype.onAddCourse = function (form) {
                    var _this = this;
                    ...
                    this.fs.addBadge(form.value).then(function (res) {
                        console.log('added');
                        _this.sbs.viewBadges("Added Badge!", 'VIEW BADGES');
                        _this.addCourse.reset();
                        _this.markFormGroupPristine(_this.addCourse);
                    });
                };
                HomeComponent.prototype.markFormGroupPristine = function (formGroup) {
                    var _this = this;
                    Object.values(formGroup.controls).forEach(function (control) {
                        control.markAsPristine();
                        if (control.controls) {
                            _this.markFormGroupPristine(control);
                        }
                    });
                };
                HomeComponent.prototype.shouldDisableImport = function () {
                ...
                HomeComponent.prototype.onLoginBadger = function (form) {
                    var _this = this;
                    if (this.badger_access_token === null || this.badger_access_token === undefined) {
                        this.bs.getAccessToken(form.value.username, form.value.password).subscribe(function (data) {
                            _this.badger_access_token = _this.badger_access_token;
            ...
            var BadgeModal = /** @class */ (function () {
                function BadgeModal(dialogRef, data) {
                    this.dialogRef = dialogRef;
                    this.data = data;
                }
                BadgeModal.prototype.onNoClick = function () {
                    this.dialogRef.close();
                };
                return BadgeModal;
            }());
            BadgeModal.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfileComponent = /** @class */ (function () {
                function ProfileComponent(as, fs, sbs, route) {
                    this.as = as;
                    this.fs = fs;
                    this.sbs = sbs;
                    this.route = route;
                ...
                ProfileComponent.prototype.getCurrUser = function () {
                    var _this = this;
                    this.fs.getUser(this.as.uid).subscribe(function (res) {
                        _this.currUser = res;
                    });
                };
                ProfileComponent.prototype.isSameUser = function () {
                    return this.as.uid == this.uid;
                };
                ProfileComponent.prototype.getUID = function () {
                    var d = this.route.params;
                    this.uid = d._value.id;
                    console.log(this.uid);
                };
                ProfileComponent.prototype.getBadges = function () {
                    var _this = this;
                    var badges = [];
                    this.fs.getBadges(this.uid).subscribe(function (res) {
                        res.forEach(function (b) {
                            var d = b.data;
                            d.id = b.id;
                            badges.push(d);
                ...
                ProfileComponent.prototype.getUser = function () {
                    var _this = this;
                    this.fs.getUser(this.uid).subscribe(function (res) {
                        _this.user = res;
                    });
                };
                ProfileComponent.prototype.endorseBadge = function (id, endorsement) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                ...
                Object.defineProperty(AuthService.prototype, "userProfilePicture", {
                    get: function () {
                ...
                AuthService.prototype.AuthLogin = function (provider) {
                    ...
                    return this.afAuth.auth.signInWithPopup(provider)
                        ...
                        _this.endorsementDoesNotExist(result.user).subscribe(function (res) {
                            _this.userData = res;
                        });
                ...
                AuthService.prototype.endorsementDoesNotExist = function (user) {
                    return this.afs
                        .collection("/users")
                        .doc(user.uid)
                        .valueChanges();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BadgerService = /** @class */ (function () {
                function BadgerService(http, sbs) {
                    this.http = http;
                    this.sbs = sbs;
                    this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("content-type", "application/json");
                }
                BadgerService.prototype.getAccessToken = function (username, password) {
                    var url = "https://api.badgr.io/o/token?username=" + username + "&password=" + password;
                    return this.http.post(url, { headers: this.headers });
                };
                BadgerService.prototype.getRefreshToken = function (token) {
                    var url = "https://api.badgr.io/o/token?grant_type=refresh_token&refresh_token=" + token.access_token;
                    return this.http.post(url, { headers: this.headers });
                };
                BadgerService.prototype.getBadges = function (token) {
                    var _this = this;
                    var url = "https://api.badgr.io/v2/backpack/assertions&token=" + token.access_token;
                    var _headers = {
                    ...
                    return this.http
                        ...
                        .subscribe(function (data) { return console.log(data); }, function (error) { return _this.sbs.dismiss('No Badges to Import', 'DISMISS'); });
                };
                return BadgerService;
            }());
            BadgerService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FireStoreService = /** @class */ (function () {
                function FireStoreService(af, as) {
                    this.af = af;
                    this.as = as;
                }
                FireStoreService.prototype.addBadge = function (data) {
                    return this.af.collection("badges").add(data);
                };
                FireStoreService.prototype.deleteBadge = function (id) {
                    return this.af
                        .collection("badges")
                        .doc(id)
                        .delete()
                ...
                FireStoreService.prototype.getBadges = function (uid) {
                    return this.af
                        .collection("/badges", function (ref) { return ref.where("uid", "==", uid); })
                        .snapshotChanges()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (actions) { return actions.map(function (a) {
                ...
                FireStoreService.prototype.getUser = function (id) {
                    return this.af
                        .collection("/users")
                        .doc(id)
                        .valueChanges();
                };
                FireStoreService.prototype.getRecommendations = function () {
                    return this.af
                        .collection("/badges", function (ref) { return ref.where("status.verified.code", "==", 1); })
                        .snapshotChanges()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (actions) { return actions.map(function (a) {
                        return { data: a.payload.doc.data(), id: a.payload.doc.id };
                    }); }));
                };
                FireStoreService.prototype.endorseBadge = function (badgeid, userid, endorsement) {
                    this.updateUserPoints(userid);
                    this.updateEndorsement(badgeid, userid, endorsement);
                };
                FireStoreService.prototype.updateUserPoints = function (userid) {
                    var decrement = firebase__WEBPACK_IMPORTED_MODULE_5__["firestore"].FieldValue.increment(-1);
                    var ref = this.af.collection("/users").doc(userid);
                    ref.update({ endorsements: decrement });
                };
                FireStoreService.prototype.updateEndorsement = function (badgeid, userid, endorsement) {
                    return this.af
                        .collection("/badges")
                        .doc(badgeid)
                        .set({
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SnackbarService = /** @class */ (function () {
                function SnackbarService(snackBar, zone, router) {
                    this.snackBar = snackBar;
                    this.zone = zone;
                    this.router = router;
                }
                SnackbarService.prototype.viewBadges = function (message, action, duration) {
                    var _this = this;
                    if (duration === void 0) { duration = 50000; }
                    this.zone.run(function () {
                        var snackBarRef = _this.snackBar.open(message, action, { duration: duration });
                        snackBarRef.onAction().subscribe(function () { return _this.goToBadges(); });
                    });
                };
                SnackbarService.prototype.dismiss = function (message, action, duration) {
                    var _this = this;
                    if (duration === void 0) { duration = 50000; }
                    this.zone.run(function () {
                        var snackBarRef = _this.snackBar.open(message, action, { duration: duration });
                        snackBarRef.onAction().subscribe(function () { return _this.snackBar.dismiss(); });
                    });
                };
                SnackbarService.prototype.goToBadges = function () {
